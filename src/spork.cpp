...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_5_INSTANTSEND_MAX_VALUE,          1000},          // 1000 SIB
    ...
    {SPORK_18_REJECT_OLD_BLOCKS,             4070908800ULL}, // OFF
};
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_18_REJECT_OLD_BLOCKS")                return SPORK_18_REJECT_OLD_BLOCKS;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_18_REJECT_OLD_BLOCKS:                return "SPORK_18_REJECT_OLD_BLOCKS";
        default:
