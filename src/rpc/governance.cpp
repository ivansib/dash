...
void gobject_vote_conf_help()
{
    throw std::runtime_error(
                ...
                "Vote on a governance object by masternode configured in sibcoin.conf\n"
                "\nArguments:\n"
...
[[ noreturn ]] void gobject_help()
{
    throw std::runtime_error(
            ...
            "  vote-conf          - Vote on a governance object by masternode configured in sibcoin.conf\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Dash features */
    { "sibcoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "sibcoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "sibcoin",               "gobject",                &gobject,                true,  {} },
    { "sibcoin",               "voteraw",                &voteraw,                true,  {} },
